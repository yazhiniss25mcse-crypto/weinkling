...
const CATEGORIES = ["Smart Touch Panels", "Control Modules", "Accessories"] as const;
...
const PRODUCTS: {
    ...
    // Smart Touch Panels
    {
        ...
        name: "Glass Panel 6M",
        config: "4 Lights + 1 Fan",
        size: "6 Module",
        image: "/images/products/panel_6m.png",
        badge: "Bestseller",
    },
    {
        category: "Smart Touch Panels",
        name: "Glass Panel 8M",
        config: "6 Lights + 2 Fan",
        size: "8 Module",
        image: "/images/products/panel_8m.png",
    },
    {
        category: "Smart Touch Panels",
        name: "Glass Panel 4M",
        config: "2 Lights + 1 Fan + Scene",
        size: "4 Module",
        image: "/images/products/panel_4m.png",
    },
    {
        category: "Smart Touch Panels",
        name: "Glass Panel Pro",
        config: "8 Lights + 2 Fan + Dimmer",
        size: "10 Module",
        image: "/images/products/panel_8m.png",
        badge: "New",
    },
    ...
    // Control Modules
    {
        ...
        name: "Curtain Module",
        config: "Open / Close / Stop",
        size: "2 Module",
        image: "/images/products/module_curtain.png",
    },
    {
        category: "Control Modules",
        name: "Smart Plug Module",
        config: "16A Load Support",
        size: "2 Module",
        image: "/images/products/module_plug.png",
    },
    {
        category: "Control Modules",
        name: "Bell Module",
        config: "24V Doorbell Support",
        size: "1 Module",
        image: "/images/products/module_bell.png",
    },
    {
        category: "Control Modules",
        name: "Switch Module",
        config: "Two-Way Compatible",
        size: "1 Module",
        image: "/images/products/module_curtain.png",
    },
    ...
    // Accessories
    {
        ...
        name: "RF Remote",
        config: "6-Scene Preset",
        size: "Handheld",
        image: "/images/products/accessory_remote.png",
        badge: "New",
    },
    {
        category: "Accessories",
        name: "Smart Hub",
        config: "Wi-Fi + RF Gateway",
        size: "Desktop",
        image: "/images/products/accessory_hub.png",
    },
    {
        category: "Accessories",
        name: "Panel Frame",
        config: "Modular Mounting Frame",
        size: "Universal",
        image: "/images/products/module_bell.png",
    },
];
...
const LED_OPTIONS = [
    { name: "Warm",    hex: "#f5d98a",  glow: "rgba(245,217,138,0.70)",  shadow: "rgba(245,217,138,0.40)" },
    { name: "Cool",    hex: "#c8e0ff",  glow: "rgba(200,224,255,0.70)",  shadow: "rgba(200,224,255,0.40)" },
    { name: "Amber",   hex: "#f5a623",  glow: "rgba(245,166,35,0.70)",   shadow: "rgba(245,166,35,0.40)"  },
    { name: "RGB",     hex: "#d670f5",  glow: "rgba(214,112,245,0.70)",  shadow: "rgba(214,112,245,0.40)" },
];
...
export default function ProductsPage() {
    const [activeCategory, setActiveCategory] = useState<Category>("Smart Touch Panels");
    ...
    const handleLedChange = (i: number) => {
        if (i === selectedLed) return;
        triggerPreviewCrossfade(() => setSelectedLed(i));
    };
            ...
            <main id="products-content" style={{ background: "#09090e" }}>
                ...
                {/* ── Background: luxury interior night scene ──────────── */}
                    <Image
                        ...
                        style={{
                            ...
                            /* Deeper darkness — photo is purely atmospheric backdrop */
                    ...
                    {/* Hero content */}
                    <div style={{ position: "relative", zIndex: 5, padding: "0 24px", maxWidth: "960px" }}>
                        {/* Eyebrow */}
                        <div style={{
                        ...
                        <h1 style={{
                            ...
                            textShadow: [
                                "0 0 60px rgba(140,180,184,0.35)",
                                "0 0 120px rgba(140,180,184,0.18)",
                                "0 0 200px rgba(140,180,184,0.09)",
                                "0 2px 8px rgba(0,0,0,0.8)",
                            ].join(", "),
                        }}>
                            Precision Meets<br />
                            <em style={{ color: "var(--clr-accent)", fontStyle: "italic", textShadow: "0 0 40px rgba(140,180,184,0.5), 0 0 80px rgba(200,169,110,0.2)" }}>Control.</em>
                        </h1>
                        ...
                        {/* Stats strip — horizontal pill style, distinct from contact page */}
                        <div
                            ref={heroStatsRef}
                            style={{
                                display: "grid",
                    ...
                    <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 48px" }}>
                        ...
                        <Reveal delay={100}>
                            <div style={{
                                ...
                                width: "fit-content", margin: "0 auto 88px",
                ...
                <section
                    ...
                    style={{
                        ...
                        padding: "140px 0",
                        background: "linear-gradient(180deg, rgba(140,180,184,0.03) 0%, transparent 100%)",
                        overflow: "hidden",
                        position: "relative",
                    }}>
                    {/* ambient glow */}
                    ...
                    <div style={{ maxWidth: "1380px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>

                        {/* Section heading — GSAP-controlled, no Reveal wrapper */}
                        <div ref={cfgHeadingRef} style={{ textAlign: "center", marginBottom: "80px" }}>
                            ...
                            <h2 style={{
                                ...
                                Built to your{" "}
                                <em style={{ color: "var(--clr-accent)" }}>exact palette.</em>
                            </h2>
                            <p style={{
                                fontFamily: "var(--font-body)", fontSize: "1rem", fontWeight: 300,
                                lineHeight: 1.8, color: "rgba(245,244,240,0.48)",
                                maxWidth: "520px", margin: "20px auto 0",
                            }}>
                                Select a finish and LED colour below. The preview updates live.
                            </p>
                        </div>

                        {/* ── 3-column configurator grid ── */}
                        <div style={{
                            display: "grid",
                            ...
                            {/* ── Column A: Config options — GSAP-controlled ── */}
                            <div ref={colARef}>
                                <div style={{ paddingTop: "24px" }}>
                                    <p style={{
                                        fontFamily: "var(--font-body)", fontSize: "0.62rem", fontWeight: 600,
                                        letterSpacing: "0.28em", textTransform: "uppercase",
                                        color: "var(--clr-accent)", marginBottom: "28px",
                                    }}>Configuration</p>

                                    {/* Config rows */}
                                    <div ref={configRowsRef} style={{ display: "flex", flexDirection: "column", gap: "14px", marginBottom: "48px" }}>
                                        {[
                                            { label: "Panel Finish",  value: COLORS[selectedColor].name,  accent: true },
                                            { label: "LED Colour",    value: LED_OPTIONS[selectedLed].name, accent: true },
                                            { label: "Icon Style",    value: "Standard engraving" },
                                            { label: "Load Capacity", value: "16A per module" },
                                            { label: "Compatibility", value: "Wi-Fi + RF + App" },
                                        ].map(opt => (
                                            <div key={opt.label} style={{
                                                ...
                                                <span style={{
                                                    ...
                                                    textTransform: "uppercase", color: "rgba(245,244,240,0.38)",
                                                }}>{opt.label}</span>
                                                <span style={{
                                                    fontFamily: "var(--font-body)", fontSize: "0.88rem",
                                                    fontWeight: 500,
                                                    color: opt.accent ? "#f5f4f0" : "rgba(245,244,240,0.6)",
                                    ...
                                    <div style={{
                                        ...
                                        background: "linear-gradient(135deg, rgba(140,180,184,0.08) 0%, rgba(200,169,110,0.05) 100%)",
                                        border: "1px solid rgba(140,180,184,0.18)",
                                    }}>
                                        <p style={{
                                            fontFamily: "var(--font-body)", fontSize: "0.78rem",
                                            fontWeight: 500, color: "rgba(245,244,240,0.7)",
                            ...
                            {/* ── Column B: Live Panel Preview — GSAP-controlled ── */}
                            <div ref={colBRef}>
                                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "24px" }}>
                                    ...
                                    {/* Panel 3D outer shell — stable ref for GSAP; inner div keyed for SVG re-render */}
                                    <div
                                        ref={panelWrapRef}
                                        style={{
                                            position: "relative",
                                    ...
                                    <div key={previewKey} style={{ position: "relative" }}>
                                        ...
                                        <div style={{
                                            ...
                                            inset: "-40px",
                                            borderRadius: "50%",
                                            background: `radial-gradient(ellipse, ${LED_OPTIONS[selectedLed].shadow} 0%, transparent 65%)`,
                                            filter: "blur(30px)",
                                            pointerEvents: "none",
                                        ...
                                        {/* SVG Panel — realistic 8-module glass panel */}
                                        <svg
                                            viewBox="0 0 220 420"
                                            width="220"
                                            height="420"
                                            style={{ position: "relative", zIndex: 1, filter: "drop-shadow(0 32px 64px rgba(0,0,0,0.6))" }}
                                        >
                                            <defs>
                                                {/* Panel surface gradient — gives depth */}
                                                <linearGradient id="panelSurface" x1="0%" y1="0%" x2="100%" y2="100%">
                                                    <stop offset="0%"    stopColor={COLORS[selectedColor].hex} stopOpacity="1" />
                                                    <stop offset="45%"   stopColor={COLORS[selectedColor].hex} stopOpacity="0.92" />
                                                    <stop offset="100%"  stopColor={COLORS[selectedColor].hex} stopOpacity="0.78" />
                                                </linearGradient>
                                                {/* Specular highlight top-left */}
                                                <linearGradient id="panelHighlight" x1="0%" y1="0%" x2="80%" y2="60%">
                                                    <stop offset="0%"   stopColor="rgba(255,255,255,0.18)" />
                                                    <stop offset="60%"  stopColor="rgba(255,255,255,0.04)" />
                                                    <stop offset="100%" stopColor="rgba(255,255,255,0)" />
                                                </linearGradient>
                                                {/* Edge bevel */}
                                                <linearGradient id="panelBevel" x1="0%" y1="0%" x2="0%" y2="100%">
                                                    <stop offset="0%"   stopColor="rgba(255,255,255,0.22)" />
                                                    <stop offset="100%" stopColor="rgba(0,0,0,0.30)" />
                                                </linearGradient>
                                                {/* LED glow gradient */}
                                                <linearGradient id="ledGlow" x1="0%" y1="0%" x2="100%" y2="0%">
                                                    <stop offset="0%"   stopColor={LED_OPTIONS[selectedLed].glow} stopOpacity="0" />
                                                    <stop offset="20%"  stopColor={LED_OPTIONS[selectedLed].glow} stopOpacity="0.7" />
                                                    <stop offset="50%"  stopColor={LED_OPTIONS[selectedLed].glow} stopOpacity="1" />
                                                    <stop offset="80%"  stopColor={LED_OPTIONS[selectedLed].glow} stopOpacity="0.7" />
                                                    <stop offset="100%" stopColor={LED_OPTIONS[selectedLed].glow} stopOpacity="0" />
                                                </linearGradient>
                                                {/* LED diffuse halo */}
                                                <radialGradient id="ledHalo" cx="50%" cy="100%" r="60%">
                                                    <stop offset="0%"  stopColor={LED_OPTIONS[selectedLed].hex} stopOpacity="0.25" />
                                                    <stop offset="100%" stopColor={LED_OPTIONS[selectedLed].hex} stopOpacity="0" />
                                                </radialGradient>
                                                <clipPath id="panelClip">
                                                    <rect x="4" y="4" width="212" height="412" rx="14" />
                                                </clipPath>
                                            </defs>
                                            ...
                                            {/* Panel body */}
                                            <rect x="4" y="4" width="212" height="412" rx="14" fill="url(#panelSurface)" />

                                            {/* Specular sheen */}
                                            <rect x="4" y="4" width="212" height="412" rx="14" fill="url(#panelHighlight)" />

                                            {/* ── Switch buttons (8 modules) ── */}
                                            {[
                                                ...
                                                const isLight = COLORS[selectedColor].hex.startsWith("#f") || COLORS[selectedColor].hex.startsWith("#d") || COLORS[selectedColor].hex.startsWith("#c") || COLORS[selectedColor].hex.startsWith("#a");
                                                return (
                                                    <g key={btn.label + btn.x}>
                                                        {/* Button recess */}
                                                        <rect
                                                            x={btn.x} y={btn.y} width={btn.w} height={btn.h} rx="8"
                                                            fill={isLight ? "rgba(0,0,0,0.07)" : "rgba(255,255,255,0.06)"}
                                                            stroke={isLight ? "rgba(0,0,0,0.12)" : "rgba(255,255,255,0.10)"}
                                                            strokeWidth="0.8"
                                                        />
                                                        {/* Touch icon dot */}
                                                        <circle
                                                            cx={btn.x + btn.w / 2} cy={btn.y + btn.h / 2 - 8} r="5"
                                                            fill={isLight ? "rgba(0,0,0,0.18)" : "rgba(255,255,255,0.22)"}
                                                        />
                                                        {/* Label */}
                                                        <text
                                                            x={btn.x + btn.w / 2} y={btn.y + btn.h / 2 + 14}
                                                            textAnchor="middle" fontSize="8"
                                                            fontFamily="Manrope, sans-serif" letterSpacing="1"
                                                            fill={isLight ? "rgba(0,0,0,0.35)" : "rgba(255,255,255,0.30)"}
                                                        >{btn.label}</text>
                                                    </g>
                                                );
                                            })}

                                            {/* ── LED indicator strip (bottom) ── */}
                                            {/* Diffuse halo above strip */}
                                            <rect x="4" y="350" width="212" height="66" rx="0" fill="url(#ledHalo)" clipPath="url(#panelClip)" />

                                            {/* LED bar */}
                                            <rect x="30" y="362" width="160" height="3" rx="1.5" fill="url(#ledGlow)" />
                                            {/* LED bar inner bright core */}
                                            <rect
                                                x="60" y="362.5" width="100" height="1.5" rx="0.75"
                                                fill={LED_OPTIONS[selectedLed].hex}
                                                opacity="0.9"
                                            />

                                            {/* Status dot */}
                                            <circle cx="110" cy="392" r="3" fill={LED_OPTIONS[selectedLed].hex} opacity="0.8" />
                                            <circle cx="110" cy="392" r="6" fill={LED_OPTIONS[selectedLed].hex} opacity="0.15" />

                                            {/* Touch sensor line at bottom */}
                                            <rect x="70" y="405" width="80" height="1" rx="0.5"
                                                fill={COLORS[selectedColor].hex.startsWith("#f") || COLORS[selectedColor].hex.startsWith("#d") ? "rgba(0,0,0,0.15)" : "rgba(255,255,255,0.15)"}
                                            />
                                        </svg>
                                    </div>{/* /.keyed-inner */}
                                    </div>{/* /.panelWrapRef */}
                                    ...
                                    <div style={{
                                        ...
                                        <p style={{
                                            fontFamily: "var(--font-body)",
                                            fontSize: "0.7rem",
                                            color: LED_OPTIONS[selectedLed].hex,
                                            letterSpacing: "0.12em",
                                            textTransform: "uppercase",
                                            transition: "color 0.3s ease",
                                            textShadow: `0 0 12px ${LED_OPTIONS[selectedLed].glow}`,
                                        }}>{LED_OPTIONS[selectedLed].name} LED</p>
                                    </div>
                                </div>
                            </div>

                            {/* ── Column C: Finish + LED Selectors — GSAP-controlled ── */}
                            <div ref={colCRef}>
                                <div style={{ paddingTop: "24px" }}>
                                    ...
                                    <p style={{
                                        fontFamily: "var(--font-body)", fontSize: "0.62rem", fontWeight: 600,
                                        letterSpacing: "0.28em", textTransform: "uppercase",
                                        color: "var(--clr-accent)", marginBottom: "20px",
                                    }}>Panel Finish</p>
                                    <div ref={swatchGridRef} style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px", marginBottom: "40px" }}>
                                        {COLORS.map((c, i) => (
                                            <button
                                                key={c.name}
                                                id={`finish-${c.name.toLowerCase().replace(/\s+/g,"-")}`}
                                            ...
                                            >
                                                <div style={{
                                                    ...
                                                    boxShadow: selectedColor === i
                                                        ? `0 0 0 3px rgba(255,255,255,0.08), 0 4px 20px ${c.glowColor}`
                                                ...
                                                <span style={{
                                                    ...
                                                    fontWeight: selectedColor === i ? 600 : 400,
                                                    letterSpacing: "0.06em",
                                                    color: selectedColor === i ? "#f5f4f0" : "rgba(245,244,240,0.4)",
                                                    transition: "color 0.3s ease",
                                    ...
                                    <div ref={ledGridRef} style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px", marginBottom: "40px" }}>
                                        {LED_OPTIONS.map((led, i) => (
                                            <button
                                                key={led.name}
                                                id={`led-${led.name.toLowerCase()}`}
                                                onClick={() => handleLedChange(i)}
                                                style={{
                                                    display: "flex", flexDirection: "column", alignItems: "center",
                                                    gap: "8px", padding: "12px 6px",
                                                    borderRadius: "12px", border: "none",
                                                    background: selectedLed === i
                                                        ? "rgba(140,180,184,0.08)"
                                                        : "rgba(255,255,255,0.03)",
                                                    outline: selectedLed === i
                                                        ? `2px solid ${led.hex}40`
                                                        : "2px solid transparent",
                                                    cursor: "pointer",
                                                    transition: "all 0.3s cubic-bezier(0.22,0.61,0.36,1)",
                                                }}
                                            >
                                                <div style={{
                                                    ...
                                                    background: led.hex,
                                                    boxShadow: selectedLed === i
                                                        ? `0 0 0 3px rgba(255,255,255,0.06), 0 4px 20px ${led.glow}`
                                                        : `0 0 8px ${led.hex}60`,
                                                    transition: "box-shadow 0.3s ease",
                                                }} />
                                                <span style={{
                                                    fontFamily: "var(--font-body)", fontSize: "0.62rem",
                                                    fontWeight: selectedLed === i ? 600 : 400,
                                                    color: selectedLed === i ? led.hex : "rgba(245,244,240,0.38)",
                                                    transition: "color 0.3s ease",
                                                    textShadow: selectedLed === i ? `0 0 10px ${led.glow}` : "none",
                                                }}>{led.name}</span>
                                            </button>
                                        ))}
                                    </div>
                                    ...
                                    <div ref={summaryPillRef} style={{
                                        ...
                                        border: `1px solid ${COLORS[selectedColor].border}40`,
                                        backdropFilter: "blur(12px)",
                                        transition: "border-color 0.5s ease",
                                        boxShadow: `0 8px 32px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.06)`,
                                    }}>
                                        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "14px" }}>
                                            <span style={{ fontFamily: "var(--font-body)", fontSize: "0.7rem", color: "rgba(245,244,240,0.38)", letterSpacing: "0.08em", textTransform: "uppercase" }}>Finish</span>
                                            <span style={{ fontFamily: "var(--font-body)", fontSize: "0.82rem", fontWeight: 600, color: "#f5f4f0", transition: "color 0.3s ease" }}>{COLORS[selectedColor].name}</span>
                                        </div>
                                        <div style={{ height: "1px", background: "rgba(255,255,255,0.06)", marginBottom: "14px" }} />
                                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                                            <span style={{ fontFamily: "var(--font-body)", fontSize: "0.7rem", color: "rgba(245,244,240,0.38)", letterSpacing: "0.08em", textTransform: "uppercase" }}>LED</span>
                                            <span style={{
                                                fontFamily: "var(--font-body)", fontSize: "0.82rem", fontWeight: 600,
                                                color: LED_OPTIONS[selectedLed].hex,
                                                textShadow: `0 0 12px ${LED_OPTIONS[selectedLed].glow}`,
                                                transition: "color 0.3s ease, text-shadow 0.3s ease",
                                            }}>{LED_OPTIONS[selectedLed].name} Backlight</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    return (
        ...
        >
            ...
            <div style={{
                ...
                height: "380px",
                overflow: "hidden",
                /* Radial spotlight: centre lighter so product pops, edges recede */
                background: "radial-gradient(ellipse at 50% 40%, #1e2238 0%, #0d0d18 55%, #080810 100%)",
            }}>
                {/* Subtle centre spotlight glow — always visible */}
                <div style={{
                    position: "absolute", inset: 0, zIndex: 1,
                    background: "radial-gradient(ellipse at 50% 38%, rgba(200,210,240,0.06) 0%, transparent 62%)",
                    pointerEvents: "none",
                }} />
                ...
                <Image
                    ...
                    style={{
                        ...
                        zIndex: 2,
                        /* Slight brightness lift so product lighting reads naturally */
            ...
            <div style={{ padding: "36px 36px 40px" }}>
                <h3 style={{
                    fontFamily: "var(--font-serif)", fontSize: "1.65rem",
